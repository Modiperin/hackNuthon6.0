...
const processImage = async () => {
  ...
  try {
    ...
    if (data.success) {
      ...
      setReferenceImage(data?.detection?.url)
      console.log(data)
    } else {
    ...
    <div className="min-h-screen bg-purple-50">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {referenceImage && (
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-xl font-semibold mb-4 text-purple-900">Reference Image</h2>
                <img src={referenceImage} alt="Reference" className="max-w-full rounded-lg" />
              </div>
            )}
          </div>
        </div>
